...
public class HelloController {
	...
	@GetMapping("/test2")
	@Operation(description = "Endpoint to request test2 resource")
	public void test2(TestRequest2 request) {
	}

	@GetMapping("/test3")
	@Operation(description = "Endpoint to request test3 resource")
	public void test3(TestRequest3 request) {
	}

	@GetMapping("/test4")
	@Operation(description = "Endpoint to request test4 resource")
